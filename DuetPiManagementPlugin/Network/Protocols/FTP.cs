...
namespace DuetPiManagementPlugin.Network.Protocols
{
    ...
    public static class FTP
    {
        ...
        /// </summary>
        private static readonly Regex _portRegex = new Regex(@"^\s*Port\s*(\d+)");
        ...
        public static async Task Init()
        {
            ...
            {
                using FileStream inetdConfig = new FileStream("/etc/proftpd/proftpd.conf", FileMode.Open, FileAccess.Read);
